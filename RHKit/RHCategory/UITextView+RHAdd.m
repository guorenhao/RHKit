...
@implementation UITextView (RHAdd)
...
- (UILabel *)placeholderLabel {
    ...
    if (!label) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(updatePlaceholderLabel) name:UITextViewTextDidChangeNotification object:self];
        for (NSString *key in self.class.observingKeys) {
...
// placeholder label is need update font
