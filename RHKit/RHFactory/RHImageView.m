...
+ (RHImageView *)imageViewWithFrame:(CGRect)frame image:(UIImage *)image contentMode:(UIViewContentMode)mode {
    ...
    RHImageView * imageView = [[RHImageView alloc] initWithFrame:frame image:image contentMode:mode tag:RHImageViewTag target:nil tapAction:NULL];
    return imageView;
}
...
+ (RHImageView *)imageViewWithImage:(UIImage *)image contentMode:(UIViewContentMode)mode {
    ...
    RHImageView * imageView = [[RHImageView alloc] initWithFrame:CGRectZero image:image contentMode:mode tag:RHImageViewTag target:nil tapAction:NULL];
    return imageView;
}
